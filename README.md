...
With Metro running, open a new terminal window/pane from the root of your React Native project, and use the following commands to build and run your Android app:
...
If everything is set up correctly, you should see your app running in the Android Emulator or your connected Android device.
...
Download the latest APK from the GitHub Releases page when a new version is published.
